...
function buildReportPayload(calc, form) {
  ...
  return {
    ...
    hasDivorceCOAP: form.hasDivorceCOAP ?? false,
    divorceAnnuitySharePct: form.divorceAnnuitySharePct ?? 0,
    coapMonthlyReduction: Math.round(fers?.coapMonthlyReduction ?? 0),
